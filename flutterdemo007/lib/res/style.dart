...
class Styles {
  ///---------------------------黑绿色字体区域-------------------------------
  static TextStyle style_1A2F51_14 = TextStyle(
    color: ColorStyle.color_1A2F51,
    fontSize: 14.sp,
  );
  static TextStyle style_1A2F51_16 = TextStyle(
    color: ColorStyle.color_1A2F51,
    fontSize: 16.sp,
  );
  static TextStyle style_1A2F51_18 = TextStyle(
    color: ColorStyle.color_1A2F51,
    fontSize: 18.sp,
  );

  ///---------------------------淡灰色字体区域-------------------------------
  static TextStyle style_B8C0D4_11 = TextStyle(
    color: ColorStyle.color_B8C0D4,
    fontSize: 11.sp,
  );
  static TextStyle style_B8C0D4_13 = TextStyle(
    color: ColorStyle.color_B8C0D4,
    fontSize: 13.sp,
  );
  static TextStyle style_B8C0D4_14 = TextStyle(
    color: ColorStyle.color_B8C0D4,
    fontSize: 14.sp,
  );

  ///---------------------------浅灰色字体区域-------------------------------
  static TextStyle style_9F9EA6_11 = TextStyle(
    color: Color(0xff9F9EA6),
    fontSize: 11.sp,
    height: 1.1.sh,
  );
  static TextStyle style_9F9EA6_14 = TextStyle(
    color: Color(0xff9F9EA6),
    fontSize: 14.sp,
    height: 1.1.sh,
  );
  static TextStyle style_616169_11 = TextStyle(
    color: Color(0xff616169),
    fontSize: 11.sp,
    height: 1.1.sh,
  );
  static TextStyle style_6A6969_14 = TextStyle(
    color: ColorStyle.color_6A6969,
    fontSize: 14.sp,
  );
  static TextStyle style_6A6969_16 = TextStyle(
    color: ColorStyle.color_6A6969,
    fontSize: 16.sp,
  );
  static TextStyle style_6A6969_28 = TextStyle(
    color: ColorStyle.color_6A6969,
    fontSize: 28.sp,
  );
  static TextStyle style_000000_30 = TextStyle(
    color: ColorStyle.color_000000,
    fontSize: 30.sp,
  );

  ///---------------------------白色字体区域-------------------------------
  static TextStyle style_white_10 = TextStyle(
    color: Colors.white,
    fontSize: 10.sp,
    height: 1.1.sh,
  );
  static TextStyle style_white_12 = TextStyle(
    color: Colors.white,
    fontSize: 12.sp,
  );
  static TextStyle style_white_14 = TextStyle(
    color: Colors.white,
    fontSize: 14.sp,
  );
  static TextStyle style_white_16 = TextStyle(
    color: Colors.white,
    fontSize: 16.sp,
  );
  static TextStyle style_white_22 = TextStyle(
    color: Colors.white,
    fontSize: 22.sp,
  );
  static TextStyle style_white_24 = TextStyle(
    color: Colors.white,
    fontSize: 24.sp,
  );
  static TextStyle style_white_18 = TextStyle(
    color: Colors.white,
    fontSize: 18.sp,
  );
  ...
  static TextStyle style_white24_18 = TextStyle(
    color: Colors.white24,
    fontSize: 18.sp,
  );
  static TextStyle style_white_36 = TextStyle(
    color: Colors.white,
    fontSize: 36.sp,
  );
  ...
  static TextStyle style_black_14 = TextStyle(
    color: Colors.black,
    fontSize: 14.sp,
  );
  static TextStyle style_black_16 = TextStyle(
    color: Colors.black,
    fontSize: 16.sp,
  );
  static TextStyle style_black_24 = TextStyle(
    color: Colors.black,
    fontSize: 24.sp,
  );
  static TextStyle style_black_32 = TextStyle(
    color: Colors.black,
    fontSize: 32.sp,
  );
  static TextStyle style_black_36 = TextStyle(
    color: Colors.black,
    fontSize: 36.sp,
  );
  static TextStyle style_black_30 = TextStyle(
    color: Colors.black,
    fontSize: 30.sp,
  );
  static TextStyle style_black_12 = TextStyle(
    color: Colors.black,
    fontSize: 12.sp,
  );
  static TextStyle style_black_13 = TextStyle(
    color: Colors.black,
    fontSize: 13.sp,
  );
  static TextStyle style_black_15 = TextStyle(
    color: Colors.black,
    fontSize: 15.sp,
  );

  static const TextStyle style_24CF5F_14 = TextStyle(
  ...
  static TextStyle style_FFAE2E_14 = TextStyle(
    color: ColorStyle.color_FFAE2E,
    fontSize: 14.sp,
  );

  static TextStyle style_FFAE2E_16 = TextStyle(
    color: ColorStyle.color_FFAE2E,
    fontSize: 16.sp,
  );
