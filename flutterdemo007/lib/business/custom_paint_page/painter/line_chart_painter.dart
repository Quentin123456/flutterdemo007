...
class LineChartPainter extends CustomPainter {
  ...
  void drawBack(Canvas canvas, Rect rect, Size size) {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      canvas.drawParagraph(
        paragraph,
        Offset(0, size.height - i * perHeight - 20.w),
      );
    }
  }
  ...
  void drawLine(Canvas canvas, Rect rect, Size size) {
    ...
    if (hasDown && dy > 0 && dx > 0) {
      ...
      ///绘制底部标签
      var leftPosition = xPosition - 40.w;
      ...
      var paragraph = paragraphBuilder.build()
        ..layout(ui.ParagraphConstraints(width: 80.w));
      canvas.drawParagraph(paragraph, Offset(leftPosition, size.height - 30.w));
    }
  }
}
