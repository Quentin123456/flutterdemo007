...
import '../../extension/get_extension.dart';
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ///标题、内容
                      Box.hBox30,
                      Text(title, style: Styles.style_black_30_bold500),
                      Padding(
                        padding: EdgeInsets.symmetric(
                          horizontal: 30.w,
                          vertical: 30.w,
                        ),
                        child: Text(content, style: Styles.style_6A6969_28),
                      ),
      ...
      child: Expanded(
        ...
        child: TextButton(
          ...
          child: Container(
            ...
            height: 60,
            child: Text(text, style: Styles.style_black_32),
          ),
        ),
      ),
    );
