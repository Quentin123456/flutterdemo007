...
class BaseNetworkImage extends CachedNetworkImage {
  ...
  BaseNetworkImage(this.imgUrl, {width, fit, height, super.key})
    : super(
        imageUrl: imgUrl,
        height: height,
        width: width,
        ...
        placeholder: (context, url) {
          ...
          return Icon(Icons.image, size: size, color: ColorStyle.color_999999);
          return Image.asset(
        ...
        errorWidget: (context, url, error) {
          ...
          return Icon(Icons.image, size: size, color: ColorStyle.color_666666);
          return Image.asset(
            "assets/images/back_placeholder.png",
            width: width,
            height: height,
