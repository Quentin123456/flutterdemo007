...
import '../business/complain/complain_record_page.dart';
import '../business/complain/complain_submit_page.dart';
import '../business/custom_paint_page/custom_paint_page.dart';
...
import '../business/search_page/search_page.dart';
    ...
    GetPage(
      ...
      children: [
        ...
        GetPage(
          ...
          page: () => RankListPage(rankType: 'historical', tagType: "route"),
          binding: RankListBinding(),
        ),
      ],
    ),
